...
const TaskSchema = new mongoose.Schema({
  ...
  linearId: { type: String, unique: true, sparse: true, trim: true },
  issueType: { type: String, enum: ['feature', 'bug', 'improvement', 'task'], default: 'task' },
  cycle: { type: String, trim: true, default: 'Backlog' },
  estimate: { type: Number, min: 0, max: 13, default: 1 },
