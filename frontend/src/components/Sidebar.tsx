...
import { LayoutDashboard, Briefcase, BarChart2, Calendar, User, LogOut, Moon, Sun, Users, Folder, Sparkles, ChevronRight } from 'lucide-react';
    ...
    <aside className="sidebar" style={{ 
      ...
      <div className="sidebar-logo" style={{ 
        ...
        <span style={{ 
          ...
          color: 'var(--text-main)' 
        }}>SkillSync <span style={{ color: 'var(--primary)' }}>AI</span></span>
      </div>
      ...
      <nav style={{ 
        ...
        {navItems.map((item) => (
          ...
          >
            ...
            <ChevronRight size={14} style={{ opacity: 0.3 }} className="chevron-indicator" />
          </NavLink>
        ))}
      </nav>
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          gap: '0.75rem'
           ...
           <div style={{ 
             width: '36px', height: '36px', borderRadius: '10px', background: 'var(--card-bg)',
           ...
           <div style={{ overflow: 'hidden' }}>
              <div style={{ fontSize: '0.85rem', fontWeight: 700, color: 'var(--text-main)', whiteSpace: 'nowrap', textOverflow: 'ellipsis' }}>{user?.name}</div>
